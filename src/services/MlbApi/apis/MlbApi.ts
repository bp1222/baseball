...
export class MlbApi extends runtime.BaseAPI {
   ...
   */
  async getAllSeasonsRaw(
    requestParameters: GetAllSeasonsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<MLBSeasons>> {
  ...
  async getAllSeasons(
    ...
    const response = await this.getAllSeasonsRaw(
      requestParameters,
      initOverrides,
    );
  ...
  async getScheduleRaw(
    requestParameters: GetScheduleRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<MLBSchedule>> {
    if (requestParameters["sportId"] == null) {
      throw new runtime.RequiredError(
        "sportId",
  ...
  async getSchedule(
    ...
    const response = await this.getScheduleRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  async getSeasonRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<MLBSeason>> {
    if (requestParameters["sportId"] == null) {
      throw new runtime.RequiredError(
        "sportId",
  ...
  async getStandingsRaw(
    requestParameters: GetStandingsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<MLBStandingsList>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      MLBStandingsListFromJSON(jsonValue),
    );
  }
  ...
  async getStandings(
    requestParameters: GetStandingsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<MLBStandingsList> {
    const response = await this.getStandingsRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  async getTeamsRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<MLBTeams>> {
    if (requestParameters["sportId"] == null) {
      throw new runtime.RequiredError(
        "sportId",
