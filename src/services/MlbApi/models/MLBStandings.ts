...
export function MLBStandingsFromJSONTyped(
  json: any,
  ...
  return {
    standingsType:
      json["standingsType"] == null ? undefined : json["standingsType"],
    league:
    ...
    teamRecords:
      json["teamRecords"] == null
        ? undefined
        : (json["teamRecords"] as Array<any>).map(MLBRecordFromJSON),
  };
}
...
export function MLBStandingsToJSON(value?: MLBStandings | null): any {
  ...
  return {
    ...
    teamRecords:
      value["teamRecords"] == null
        ? undefined
        : (value["teamRecords"] as Array<any>).map(MLBRecordToJSON),
  };
}
