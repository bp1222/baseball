...
export function MLBTeamFromJSONTyped(
  json: any,
  ...
  return {
    ...
    allStarStatus:
      json["allStarStatus"] == null ? undefined : json["allStarStatus"],
    season: json["season"] == null ? undefined : json["season"],
    venue: json["venue"] == null ? undefined : MLBVenueFromJSON(json["venue"]),
    springVenue:
      json["springVenue"] == null
        ? undefined
        : MLBVenueFromJSON(json["springVenue"]),
    ...
    firstYearOfPlay:
      json["firstYearOfPlay"] == null ? undefined : json["firstYearOfPlay"],
    league:
      json["league"] == null ? undefined : MLBLeagueFromJSON(json["league"]),
    springLeague:
      json["springLeague"] == null
        ? undefined
        : MLBLeagueFromJSON(json["springLeague"]),
    division:
      json["division"] == null
        ? undefined
        : MLBDivisionFromJSON(json["division"]),
    sport: json["sport"] == null ? undefined : MLBSportFromJSON(json["sport"]),
    shortName: json["shortName"] == null ? undefined : json["shortName"],
    franchiseName:
      json["franchiseName"] == null ? undefined : json["franchiseName"],
