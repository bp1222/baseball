...
export function GameTeamFromJSONTyped(
  json: any,
  ...
  return {
    leagueRecord: !exists(json, "leagueRecord")
      ? undefined
      : GameTeamLeagueRecordFromJSON(json["leagueRecord"]),
    ...
    seriesNumber: !exists(json, "seriesNumber")
      ? undefined
      : json["seriesNumber"],
  };
}
