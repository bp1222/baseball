...
export function GameFromJSONTyped(json: any, ignoreDiscriminator: boolean): Game {
    ...
    return {
        ...
        'officialDate': !exists(json, 'officialDate') ? undefined : json['officialDate'],
        'rescheduledTo': !exists(json, 'rescheduledTo') ? undefined : json['rescheduledTo'],
        'rescheduledToDate': !exists(json, 'rescheduledToDate') ? undefined : json['rescheduledToDate'],
        'rescheduledFrom': !exists(json, 'rescheduledFrom') ? undefined : json['rescheduledFrom'],
        'rescheduledFromDate': !exists(json, 'rescheduledFromDate') ? undefined : json['rescheduledFromDate'],
        'status': !exists(json, 'status') ? undefined : StatusFromJSON(json['status']),
        'teams': !exists(json, 'teams') ? undefined : GameTeamsFromJSON(json['teams']),
        'venue': !exists(json, 'venue') ? undefined : VenueFromJSON(json['venue']),
        'content': !exists(json, 'content') ? undefined : GameContentFromJSON(json['content']),
        'isTie': !exists(json, 'isTie') ? undefined : json['isTie'],
        'gameNumber': !exists(json, 'gameNumber') ? undefined : json['gameNumber'],
        'publicFacing': !exists(json, 'publicFacing') ? undefined : json['publicFacing'],
        'doubleHeader': !exists(json, 'doubleHeader') ? undefined : json['doubleHeader'],
        ...
        'calendarEventID': !exists(json, 'calendarEventID') ? undefined : json['calendarEventID'],
        'seasonDisplay': !exists(json, 'seasonDisplay') ? undefined : json['seasonDisplay'],
        'dayNight': !exists(json, 'dayNight') ? undefined : json['dayNight'],
        'description': !exists(json, 'description') ? undefined : json['description'],
        'scheduledInnings': !exists(json, 'scheduledInnings') ? undefined : json['scheduledInnings'],
        'reverseHomeAwayStatus': !exists(json, 'reverseHomeAwayStatus') ? undefined : json['reverseHomeAwayStatus'],
        'inningBreakLength': !exists(json, 'inningBreakLength') ? undefined : json['inningBreakLength'],
        'gamesInSeries': !exists(json, 'gamesInSeries') ? undefined : json['gamesInSeries'],
        'seriesGameNumber': !exists(json, 'seriesGameNumber') ? undefined : json['seriesGameNumber'],
        ...
        'ifNecessaryDescription': !exists(json, 'ifNecessaryDescription') ? undefined : json['ifNecessaryDescription'],
    };
}
