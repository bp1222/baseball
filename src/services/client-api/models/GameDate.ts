...
export function GameDateFromJSONTyped(json: any, ignoreDiscriminator: boolean): GameDate {
    ...
    return {
        ...
        'totalGamesInProgress': !exists(json, 'totalGamesInProgress') ? undefined : json['totalGamesInProgress'],
