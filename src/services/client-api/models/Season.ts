...
export function SeasonFromJSONTyped(
  json: any,
  ...
  return {
    ...
    preSeasonStartDate: !exists(json, "preSeasonStartDate")
      ? undefined
      : json["preSeasonStartDate"],
    preSeasonEndDate: !exists(json, "preSeasonEndDate")
      ? undefined
      : json["preSeasonEndDate"],
    seasonStartDate: !exists(json, "seasonStartDate")
      ? undefined
      : json["seasonStartDate"],
    springStartDate: !exists(json, "springStartDate")
      ? undefined
      : json["springStartDate"],
    springEndDate: !exists(json, "springEndDate")
      ? undefined
      : json["springEndDate"],
    regularSeasonStartDate: !exists(json, "regularSeasonStartDate")
      ? undefined
      : json["regularSeasonStartDate"],
    lastDate1stHalf: !exists(json, "lastDate1stHalf")
      ? undefined
      : json["lastDate1stHalf"],
    allStartDate: !exists(json, "allStartDate")
      ? undefined
      : json["allStartDate"],
    firstDate2ndHalf: !exists(json, "firstDate2ndHalf")
      ? undefined
      : json["firstDate2ndHalf"],
    regularSeasonEndDate: !exists(json, "regularSeasonEndDate")
      ? undefined
      : json["regularSeasonEndDate"],
    postSeasonStartDate: !exists(json, "postSeasonStartDate")
      ? undefined
      : json["postSeasonStartDate"],
    postSeasonEndDate: !exists(json, "postSeasonEndDate")
      ? undefined
      : json["postSeasonEndDate"],
    offSeasonStartDate: !exists(json, "offSeasonStartDate")
      ? undefined
      : json["offSeasonStartDate"],
    offSeasonEndDate: !exists(json, "offSeasonEndDate")
      ? undefined
      : json["offSeasonEndDate"],
    seasonLevelGamedayType: !exists(json, "seasonLevelGamedayType")
      ? undefined
      : json["seasonLevelGamedayType"],
    gameLevelGamedayType: !exists(json, "gameLevelGamedayType")
      ? undefined
      : json["gameLevelGamedayType"],
    qualifierPlateAppearances: !exists(json, "qualifierPlateAppearances")
      ? undefined
      : json["qualifierPlateAppearances"],
    qualifierOutsPitched: !exists(json, "qualifierOutsPitched")
      ? undefined
      : json["qualifierOutsPitched"],
  };
}
