...
import { LeagueFromJSON, LeagueFromJSONTyped, LeagueToJSON } from "./League";
import type { Sport } from "./Sport";
import { SportFromJSON, SportFromJSONTyped, SportToJSON } from "./Sport";
...
export function TeamFromJSONTyped(
  ...
  return {
    ...
    allStarStatus: !exists(json, "allStarStatus")
      ? undefined
      : json["allStarStatus"],
    ...
    locationName: !exists(json, "locationName")
      ? undefined
      : json["locationName"],
    firstYearOfPlay: !exists(json, "firstYearOfPlay")
      ? undefined
      : json["firstYearOfPlay"],
    league: !exists(json, "league") ? undefined : json["league"],
    springLeague: !exists(json, "springLeague")
      ? undefined
      : json["springLeague"],
    division: !exists(json, "division") ? undefined : json["division"],
    sport: !exists(json, "sport") ? undefined : json["sport"],
    shortName: !exists(json, "shortName") ? undefined : json["shortName"],
    franchiseName: !exists(json, "franchiseName")
      ? undefined
      : json["franchiseName"],
