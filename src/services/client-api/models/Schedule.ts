...
export function ScheduleFromJSONTyped(json: any, ignoreDiscriminator: boolean): Schedule {
    ...
    return {
        ...
        'dates': !exists(json, 'dates') ? undefined : ((json['dates'] as Array<any>).map(GameDateFromJSON)),
    };
}
...
export function ScheduleToJSON(value?: Schedule | null): any {
    ...
    return {
        ...
        'dates': value.dates === undefined ? undefined : ((value.dates as Array<any>).map(GameDateToJSON)),
    };
}
